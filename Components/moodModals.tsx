...
const styles = StyleSheet.create({
  ...
  fancy: {fontFamily: 'DancingScript-Regular', fontSize: 70, marginBottom: -25, textAlign: 'center'},
  Hard: {fontFamily: 'Poppins-ExtraBold', fontSize: 60, marginBottom: -15, textAlign: 'center'},
  Emoji: {fontSize: 200, textAlign: 'center'},
  topPart: {marginHorizontal: 'auto', marginTop: 30},
  strict: {fontFamily: 'Lora-Regular', fontSize: 30, textAlign: 'center', borderRadius: 20, padding: 10},
  button: {
    width: '75%',
    position: 'absolute',
    bottom: 30,

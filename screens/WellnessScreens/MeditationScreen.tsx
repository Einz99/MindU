...
export default function MeditationScreen() {
  ...
  const STORAGE_KEY = 'FinishedMeditation';
  ...
  const clearFinishedMeditation = async () => {
    try {
      await AsyncStorage.removeItem('FinishedMeditation');
      console.log('FinishedMeditation cleared');
    } catch (error) {
      console.error('Error clearing FinishedMeditation:', error);
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.MeditationBox}>
        <Text style={styles.MeditationTitle} onPress={clearFinishedMeditation}>Meditation Guides</Text>
      </View>
              ...
              return (
                ...
                >
                  <Image
                    source={
                      isUnlocked
                        ? require('../../assets/images/MG.png')  // Unlocked Image
                        : require('../../assets/images/MGLock.png')  // Locked Image
                    }
                    style={styles.image}
                    resizeMode="contain"
                  />
